...
const Support = () => {
    return (
        <div className='p-4 rounded-xl font-pppins md:p-2 bg-white w-full md:w-1/3 mx-auto border-2 md:border-0 flex flex-col gap-2 shadow-2xl shadow-[#1E8FD0]'>
                <div className='ps-16'>
               ...
               <Lottie className='h-36 ms-0' animationData={phone} loop={true} />
                <a className='text-2xl font-bold' href="tel:09611305423"> +8809611305423</a>
               </div>
            </div>
    );
};
