...
const CreateParcel = ({ isVisible, onClose, user }) => {
    ...
    return (
        ...
        //                             <select className="w-full p-3" id="subcategory" value={subCategory} onChange={handleThanaOnChange}>
        ...
        <div>
            ...
            <select id="district" value={district} onChange={handleDistrictOnChange}>
                <option value="">Select a district</option>
                <option value="Dhaka">Dhaka</option>
                <option value="Sherpur">Chottogram</option>
                <option value="Jamalpur">Borishal</option>
            </select>
            ...
            {category && (
                <div>
                    ...
                    >
                        ...
                        {district === "Dhaka" && (
                            <>
                                <option value="subcat1">Mirpur</option>
                                <option value="subcat2">Gulshan</option>
                            </>
                        )}
                        {district === "category2" && (
                            <>
                                <option value="subcat3">Fhotikchori</option>
                                <option value="subcat4">Cox Bazar</option>
                            </>
                        )}
                        {district === "category3" && (
                            <>
                                <option value="subcat5">Borishal cini nah</option>
                                <option value="subcat6">Borishal jamu nha</option>
                            </>
                        )}
                    </select>
                </div>
                ...
                <>
                    <div>
                        <input
                            ...
                            className="border border-black-1"
                            type="text"
                        />
                    </div>
                </>
