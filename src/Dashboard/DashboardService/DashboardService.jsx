    ...
    return (
        <div>
            <div className='mb-4 px-2'>
                <h1 className="text-4xl text-center font-pppins mt-5">
                    Delivery Charges
                </h1>
                <div>
                    <div className="grid grid-cols-4 gap-1 nd:gap-5 mt-10 px-2 md:px-0">
                        <div>
                            ...
                            <div className="bg-[#020531] text-white font-pppins rounded-tl-3xl rounded-br-3xl p-5 flex flex-col divide-y mt-5">
                                <h1 className="md:text-sm font-semibold mb-2">
                                    Standard up to 1kg
                                </h1>
                                <h1 className="md:text-sm font-semibold mb-2">
                                    Per Additional kg
                        ...
                        <div>
                            ...
                            <div className="bg-[#020531] text-white font-pppins rounded-tl-3xl rounded-br-3xl p-5 flex flex-col divide-y mt-5 text-center">
                                <h1 className="md:text-sm font-semibold mb-2">70 Tk</h1>
                                <h1 className="md:text-sm font-semibold mb-2">20 Tk</h1>
                            </div>
                        </div>
                        <div>
                            <h1 className="p-1 md:p-3 flex justify-center items-center md:font-pppins bg-[#CFFCFF] rounded-bl-3xl rounded-tr-3xl text-center">
                            ...
                            <div className="bg-[#020531] text-white font-pppins rounded-tl-3xl rounded-br-3xl p-4 flex flex-col divide-y mt-5 text-center">
                                <h1 className="ms:text-sm font-semibold mb-2">110 Tk</h1>
                                <h1 className="ms:text-sm font-semibold mb-2">25 Tk</h1>
                            </div>
                        </div>
                        <div>
                            <h1 className="p-1 md:p-3 flex justify-center items-center md:font-pppins bg-[#CFFCFF] rounded-bl-3xl rounded-tr-3xl text-center">
                            ...
                            <div className="bg-[#020531] text-white font-pppins rounded-tl-3xl rounded-br-3xl p-5 flex flex-col divide-y mt-5 text-center">
                                <h1 className="md:text-sm font-semibold mb-2">130 Tk</h1>
                                <h1 className="md:text-sm font-semibold mb-2">30 Tk</h1>
                            </div>
                        </div>
                    </div>
                    <div>
