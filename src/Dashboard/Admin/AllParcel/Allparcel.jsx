    ...
    return (
        <div className='rounded-md p-2 h-full'>
            ...
            <div className='bg-sky-400 rounded-md p-10 '>
                ...
                {
                    allParce.map((user, index) => <tr className='bg-[#EEEEEE] rounded-md grid md:grid-cols-9 mb-5 justify-items-center items-center shadow-lg text-xl font-josefin p-2' key={user._id}>
                        <td>{index + 1}</td>
                            <td>7/10/2023</td>
                            <td>
