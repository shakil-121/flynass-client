...
const ProfileUpdate = ({ isVisible, onClose, user }) => {
    ...
    return (
        <div className='fixed inset-0  bg-opacity-25 backdrop-blur-sm flex justify-center items-center'>
            <div className='w-[600px] flex flex-col  rounded-lg'>
                ...
                <div className='bg-red-200 rounded-md p-10 roun'>
                        ...
                        <form>
                            ...
                            <div className='flex justify-between'>
                                ...
                                <div className='mb-4'>
                                    ...
                                    <input type='text' className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' placeholder='Enter Name' defaultValue="N/A" />
                                </div>
                            </div>
                        </form>
                    </div>
