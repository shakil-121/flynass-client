            ...
            <div className='flex flex-col  rounded-lg'>
                ...
                <div className='bg-[#1E62D4] rounded-md p-10'>
                    ...
                    <div className='h-[600px] w-[90vh] overflow-auto'>
                        ...
                        {
                            isVisible.map((parcel, index) => <tr className='bg-[#EEEEEE] rounded-md grid md:grid-cols-5 mb-5 justify-items-center items-center shadow-lg text-xl font-josefin p-2' key={parcel._id}>
                                <td>{index + 1}</td>
                                <td>{parcel.date}</td>
